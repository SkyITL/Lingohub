...
// Trust proxy - important for Vercel and other reverse proxies
// This allows express-rate-limit to use X-Forwarded-For header for accurate IP detection
...
// Rate limiting - configured for Vercel with trust proxy
