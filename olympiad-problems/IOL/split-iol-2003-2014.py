#!/usr/bin/env python3
"""
Split IOL individual problem PDFs for years 2003-2014
"""
...
def main():
    # Years to process (2003-2014)
    years = list(range(2003, 2015))

    base_dir = "/Users/skyliu/Lingohub/olympiad-problems/IOL/by-year"

    print("=" * 80)
    print("IOL PDF Splitter - Splitting individual problems (2003-2014)")
    print("=" * 80)
    ...
    print(f"  Failed/Skipped: {failed_count} years")
    if skipped_scans:
        print(f"  Scanned images (need manual split): {skipped_scans}")
